...
const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["React", "Vercel", "Supabase", "AWS Lambda", "Vite"],
    github: "https://github.com/sumanbiswas7/prayash" as string | null,
    live: "https://proyash.vercel.app" as string | null,
    org: "Proyash",
    year: "2026",
    ongoing: true,
  },
  {
    ...
    tags: ["React", "Mantine","MongoDB", "NodeJS", "Express"],
